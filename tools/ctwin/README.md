...
design/exploration allocation. Results append to a JSONL journal and compact
into the JSON checkpoint every 1,000 pairs, avoiding quadratic checkpoint I/O
while remaining restartable. At the wall-time limit, the scheduler finishes
every reserved color pair before its final checkpoint.
