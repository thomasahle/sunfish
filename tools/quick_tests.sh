...
# exact-0 info lines produced by crossed TT bounds (the depth-0
# stand-pat/correction override conflict; see tests/test_tt_consistency.py).
# The engine's settled scores on those two positions were -266/-246.
