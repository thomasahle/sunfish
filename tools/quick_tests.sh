...
echo "Mate in 1..."
#$T "$1" ${2:-"--quiet"} mate $TESTF/mate1.fen --depth 2
$T "$1" ${2:-"--quiet"} mate $TESTF/mate1.fen --movetime 10000
echo
...
# $T "$1" ${2:-"--quiet"} mate $TESTF/nullmove_mates.fen --depth 12

# These mates should be findable at depth=4, but because of null-move
# We need to go to depth=6.
echo "Mate in 2..."
#$T "$1" ${2:-"--quiet"} mate $TESTF/mate2.fen --mate-depth 4 --limit 20
$T "$1" ${2:-"--quiet"} mate $TESTF/mate2.fen --movetime 10000 --limit 20
echo

echo "Mate in 3..."
$T "$1" ${2:-"--quiet"} mate $TESTF/mate3.fen --movetime 10000 --limit 5
echo

echo "Stalemate in 0..."
$T "$1" ${2:-"--quiet"} draw $TESTF/stalemate0.fen --movetime 10000
echo

echo "Stalemate in 1..."
$T "$1" ${2:-"--quiet"} draw $TESTF/stalemate1.fen --movetime 10000
echo
...
$T "$1" ${2:-"--quiet"} draw $TESTF/stalemate2.fen --depth 4 --floor 17
echo
...
$T "$1" ${2:-"--quiet"} best $TESTF/win_at_chess_test.epd --depth 3 --floor 87
$T "$1" ${2:-"--quiet"} best $TESTF/bratko_kopec_test.epd --depth 4 --floor 4
$T "$1" ${2:-"--quiet"} best $TESTF/3fold.epd --depth 4 --floor 2
echo

echo "Other puzzles..."
$T "$1" ${2:-"--quiet"} best $TESTF/win_at_chess_test.epd --movetime 100
echo
