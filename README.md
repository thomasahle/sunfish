...
[Play now on Lichess!](https://lichess.org/@/sunfish-engine) (requires log in) or play against [Recursing's Rust port](https://github.com/Recursing/sunfish_rs) 
also [on Lichess](https://lichess.org/@/sunfish_rs). 
# Features
