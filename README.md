...
comments and whitespace, it takes up just 142 lines of code!
...
For a true minimalist experience, sunfish can be packed as a single executable of less than 4kb:
<pre>
