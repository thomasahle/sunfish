...
[UCI](http://wbec-ridderkerk.nl/html/UCIProtocol.html) interface, and removing comments and whitespace,
it takes up just 148 lines of code! (`tools/build/clean.sh sunfish.py | wc -l`).
