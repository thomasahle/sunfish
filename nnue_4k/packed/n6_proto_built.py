...
_U = ((1 << 192) - 1) // 65535
_R2 = 1 | 1 << 96                # replicate one block's word into both
...
_w = 0
for _c in "?i0=]Z_j*+g{EfITz-]pawz)Jz:k+pH@bpg``'vBlgHSL0KA)U<)v9xX1Vu)NK2D7g7[W%Lf[0[5e;qQ>J%n,Mc>HDDaK##bi,kSjXm9CuKRhwXP0%3<^'vk*Q|V,hK2/fAxSmM&'T'xTy~`6=R)Z[5X;swfi?.~+B7*=1.lt-Ii=J~s#l;iS$b5XKX6RG&)ekvmw$9do@O6:yeGu;Iv2gD39[9,a+1Y3?gbIytxFm+|;AvCLtMprA@g#GX0|o|*<}%[x2ymboE{KND0]R5w:@kn9w+sk#O]/?>5,wXojEoJ8BU+Hwo9=X>&3.0UFBb#twl<krM>H~:hN~Oo]QGH`^]J`4Lg')XaBr~jIJad|/QuZ;N;b[AEA<JLpNu2.*da_=^Y+2NNsoU1hY]m<Y;/InrZn0=.IRxusssgI]>XMPH}o)avNXZX-:Qmg5|foLW=*rC-w&4KD^/cR$$XLe20&<HL&Y9#SRI;Dv>faE,{Y{ZA/Cd,E.51nqqZB/l~$P-<KDYl-_'n0N@UW/}`~e3qR<A1PyM,~$ivA*i[l_>B{R$nI-}k&SYe&OF1e1dR@Z&RfUP0eB-lly&VRfWXjfzrUW9K#Ydl%A.x9l`9/V%;bb4m<x=NG-c52?'J]_OIr9_YQ-',)bIJKImD_o$cbMF_T7-u.|NWxj&|t~`~%GXA7h0#0?>&`bns:'J_5[X1ynRto{Gq[k^F.c=3Na4w[cqz9&{*KFzEzuu2>JMPJoE,i^XC8kNJ0#%;o:XDnYDiLc6<7],|?c_{je|EA9Qtd5?YqGy]ol;7U*<t`w%~?y*w[>T8HW=EH7]sdWOs;,P+2KFW%D5CdK[BN:5|;F,)<~'Px{@kipimGkwc2*uSiN?ZgYg$k[9AGp%O6DTN~}pl+Zfi8kMO:,C~f2lG8?.`T?6$^F)$+bI.'?=KCbh&HzT__[^^&LJ+MWX1,|MDgwS8DV{x{tk5}@v4,g'@4a%w./j`V4K)@UbS9:Vq-3CIDJm%nhhFU`~s&oVSYg7Q=1Y{]2mM7[Wl0WxSH.?~'th6F%;L#C*k)Uoze,%e1CLrO0]l1oSdZZ0`Heh',Xw^Q:B%%0~@u)O0ydW^pF?]g}V`=;wxxVR|/Bz&9,$=A7kvdV_FXHSgsddmd'":
...
_rows0 = {_p: [_half[_p][_s] + (_half[_p.swapcase()][119 - _s] << 96)
...
def nn_cp(acc, pf):
    ...
    v = y % (1 << 96) % 65535 - (y >> 96) % 65535  # 2^16 == 1 (mod 2^16-1)
    if pf:
        v = -v
