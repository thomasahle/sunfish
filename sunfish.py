...
pst = {
    'P': (   0,   0,   0,   0,   0,   0,   0,   0,
            70,  75,  77,  66,  92,  74,  77,  81,
             6,  26,  19,  40,  36,  28,  40,   6,
           -15,  14,  -2,  14,  13,   0,  14, -12,
           -23,   3,   9,   8,   5,   1,   0, -21,
           -20,   8,   5, -10,  -9,  -2,   3, -17,
           -28,   7,  -6, -33, -32, -13,   3, -28,
             0,   0,   0,   0,   0,   0,   0,   0),
    'N': ( -73, -58, -83, -83, -11, -61, -64, -77,
            -3,  -7, 110, -40,   4,  68,  -4, -15,
            11,  74,   1,  81,  80,  30,  68,  -2,
            26,  26,  50,  41,  36,  45,  28,  19,
            -1,   6,  34,  23,  24,  39,   2,   0,
           -20,  11,  14,  24,  20,  17,  12, -15,
           -25, -17,   2,   0,   2,   0, -25, -22,
           -81, -25, -29, -26, -21, -39, -24, -76),
    'B': ( -65, -86, -90, -84, -25,-118, -41, -55,
           -12,  22,  39, -46, -43,  34,   2, -24,
           -10,  43, -35,  45,  57, -11,  31, -15,
            28,  19,  22,  37,  29,  28,  17,  11,
            14,  11,  19,  25,  19,  18,   0,   8,
            15,  28,  26,  17,   9,  28,  22,  17,
            21,  22,  12,   7,   8,   7,  22,  18,
            -8,   2, -17, -13, -15, -17, -11, -11),
    'R': (  25,  20,  23,   3,  26,  23,  39,  35,
            39,  20,  39,  47,  39,  43,  24,  42,
            13,  25,  20,  23,  32,  19,  18,  11,
             0,   4,  11,   9,  13,  -3,  -6,  -4,
           -20, -25, -11, -15,  -9, -20, -32, -21,
           -29, -20, -29, -18, -18, -25, -18, -32,
           -37, -27, -22, -18, -20, -30, -31, -37,
           -21, -17, -13,   4,  -1, -13, -22, -22),
    'Q': (   7,   1,  -9,-114,  76,  26,  97,  29,
            15,  35,  66, -11,  22,  84,  63,  26,
            -2,  47,  35,  66,  79,  69,  47,   2,
             1, -18,  24,  19,  28,  22, -14,  -7,
           -15, -17,  -2,  -6,  -1, -11, -22, -24,
           -33,  -7, -14, -12, -18, -12, -18, -30,
           -40, -20,   0, -21, -17, -17, -23, -42,
           -43, -33, -34, -14, -34, -40, -37, -46),
    'K': (   4,  49,  42, -89, -89,  54,  75, -56,
           -29,   9,  50,  50,  50,  50,   9,   3,
           -56,  11, -51,  40, -60,  25,  33, -28,
           -50,  45,  10,  -4, -17,  12,   0, -44,
           -50, -39, -47, -25, -46, -42,  -7, -45,
           -42, -38, -39, -71, -58, -29, -26, -29,
            -4,   3, -13, -45, -51, -16,  12,   4,
            15,  27,  -3, -13,   5,  -1,  36,  16),
}
...
# -40 -24 ... -24 -40
# -56 -40 ... -40 -56
K_MID, K_END = pst["K"], tuple(piece["K"] + 56
   - 8 * (abs(2 * (i // 10) - 11) + abs(2 * (i % 10) - 9)) for i in range(120))
