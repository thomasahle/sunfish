...
class Searcher:
    ...
    def bound(self, pos, gamma, depth, root=True):
        ...
        # Depth <= 0 is Quiescence Search.
        # Here any position is searched as deeply as is needed for calmness,
        # and so there is no reason to keep different depths in the transposition table.
        depth = max(depth, 0)
        ...
        def moves():
            ...
            # For Quiescence Search we have a different kind of null-move
            if depth == 0:
                yield None, pos.score
            # Then killer move. We search it twice, but the tp will fix things for us.
            # Note, we don't have to check for legality, since we've already done it before.
            # Also note that in QS the killer must be a capture, otherwise we will be non deterministic.
    ...
    def _search(self, pos):
        ...
        for depth in range(1, 1000):
            ...
            # 'while lower != upper' would work, play tests show a margin of 20 plays better.
